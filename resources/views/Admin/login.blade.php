        ...
        <div class="card">
            <div class="login-box">
                ...
                <div class="login-snip">
                    ...
                    <!-- fonget page  -->
                    <input id="tab-3" type="radio" name="tab" class="forget" />
                    <label for="tab-3" class="tab skl d-none">Forget</label>

                    <!-- login page  -->
                    <input id="tab-1" type="radio" name="tab" class="sign-in" checked />
                    <label for="tab-1" class="tab text-center w-100 tabs" style="cursor: pointer">Admin Login</label>



                    <!-- sing up page  -->
                    <input id="tab-2" type="radio" name="tab" class="sign-up" />
                    <label for="tab-2" class="tab d-none tabs">Sign Up</label>
                    ...
                    <div class="login-space">
                        <form class="login" method="post" action="{{route('admin.login')}}">
                            ...
                            <div class="group"><label for="email" class="label">Email</label>
                                <input id="email" name="email" value="{{old('email')}}" type="email" class="input" placeholder="Enter your Email" />
                            </div>
                            <div class="group">
                                <label for="pass" class="label">Password</label>
                                <input id="pass" name="password" value="{{old('password')}}" type="password" class="input"  placeholder="Enter your password" />
                            </div>
                            <div class="group">
                                <input id="check" name="remember" {{ old('remember') ? 'checked' : '' }}  type="checkbox" class="check" />
                                <label for="check">
                                    <span class="icon"></span> Keep me Signed in</label>
                            </div>
                            <div class="group"><input type="submit" class="button" value="Sign In" /></div>
                            <div class="hr"></div>
                            <div class="foot d-none"><label for="tab-2">Don't Have an Account?</label></div>
                            <div class="foot"><label for="tab-3" class="forgot " style="cursor: pointer">Forgot Password?</label></div>
                        </form>
                        ...
                        <form method="post" action="{{route('register')}}" class="sign-up-form">
                            ...
                            <div class="group">
                                ...
                                <input id="pass" name="password_confirmation"  value="{{old('password_confirmation')}}" type="password" class="input" data-type="password"
                        ...
                        <div class="forget-page">
                            ...
                            <div class="foot d-none"><label for="tab-2" class="tabs">Don't Have an Account?</label></div>
                        </div>
