        ...
        <!-- /.card-header -->
            ...
            <form action="{{route('photo.update')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="hidden" class="form-control"  name="id" value="{{$photos->id}}">
                        <input type="file" value="{{old('img1')}}" class="form-control @error ('img1') is-invalid @enderror" name="img1" id="file">
                        @error('img1')
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                        <img src="{{asset('uploads/image/'.$photos->img1)}}" id="image"  style="width: 80px">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                        <img src="{{asset('uploads/image/'.$photos->img2)}}" id="image2"  style="width: 80px">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                        <img src="{{asset('uploads/image/'.$photos->img3)}}" id="image3"  style="width: 80px">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                        <img src="{{asset('uploads/image/'.$photos->img4)}}" id="image4"  style="width: 80px">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input @error ('status') is-invalid @enderror" type="radio" name="status" id="active"{{$photos->status == 1 ? 'checked' : ''}}  value="1">
                        <label class="form-check-label" for="active">Active</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input  @error ('status') is-invalid @enderror" type="radio" name="status" id="inactive"{{$photos->status == 0 ? 'checked' : ''}} value="0" >
