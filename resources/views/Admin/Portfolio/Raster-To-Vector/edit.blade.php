...
@section('content')
    ...
    <div class="card card-info  " style="height: 530px">
        ...
        <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('raster.update')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="hidden" class="form-control"  name="id" value="{{$rasters->id}}">
                        <input type="file" value="{{old('img1')}}" class="form-control @error ('img1') is-invalid @enderror" name="img1" id="file">
                        @error('img1')
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                        <img src="{{asset('uploads/image/'.$rasters->img1)}}" id="image"  style="width: 80px">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                        <img src="{{asset('uploads/image/'.$rasters->img2)}}" id="image2"  style="width: 80px">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                        <img src="{{asset('uploads/image/'.$rasters->img3)}}" id="image3"  style="width: 80px">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="alert alert-danger">{{$message}}</div>
                        @enderror
                        <img src="{{asset('uploads/image/'.$rasters->img4)}}" id="image4"  style="width: 80px">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input @error ('status') is-invalid @enderror" type="radio" name="status" id="active"{{$rasters->status == 1 ? 'checked' : ''}}  value="1">
                        <label class="form-check-label" for="active">Active</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input  @error ('status') is-invalid @enderror" type="radio" name="status" id="inactive"{{$rasters->status == 0 ? 'checked' : ''}} value="0" >
