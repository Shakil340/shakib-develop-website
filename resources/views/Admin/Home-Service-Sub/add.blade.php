...
@section('content')
    ...
    <div class="card card-info  " style="height: 530px">
        ...
        @endif
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('home-sub.store')}}" method="post" >
                @csrf

                <div class="form-group p-relative">

                    <select name="home_services_id" class="form-control name" id="skb">
                        <option>Select Service</option>

                        @php
                           use App\Models\HomeServiceSubTitle;use App\Models\HomeService;$services = HomeService::where('status',1)->get();
                        @endphp
