                                        ...
                                        <tr class="text-center">
                                            ...
                                            <script>
                                                // Set the date we're counting down to
                                                    ...
                                                    var countDownDate = new Date('{{ $pkk }}').getTime();
                                                    ...
                                                    var ss = document.querySelectorAll('.demo');
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('order.allSoftDelete', $al->id) }}"
                                                    onclick="return confirm('Are You Sure')">{{ $al->status == 1 ? '' : 'Cancel' }}</a>
