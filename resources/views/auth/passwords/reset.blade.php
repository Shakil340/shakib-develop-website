        ...
        <div class="card">
            <div class="login-box">
                ...
                <div class="login-snip">
                    ...
                    <label for="tab-1" class="tab tabs">Login</label>
                    ...
                    <div class="login-space">
                        <form class="login" method="post" action="{{ route('password.update') }}">
                            ...
                            <div class="group"><label for="email" class="label">Email</label>
                                <input id="email" name="email" value="{{ $email ?? old('email') }}" type="email" class="input" placeholder="Enter your Email" />
                            </div>
                            ...
                            <div class="group">
                                <label for="pass" class="label">Password</label>
                                <input id="pass" name="password_confirmation" value="{{old('password_confirmation')}}" type="password" class="input"  placeholder="Enter your password" />
                            </div>
